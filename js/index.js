	...
	window.tram = function(t) {
		...
		var S = e.frame = function() {
			...
			X = f(function(t) {
				...
				t.init = function(t, e, i, r) {
					...
					var a = e[0];
					i[2] && (a = i[2]), Z[a] && (a = Z[a]), this.name = a, this.type = i[1], this.duration = u(e[1], this.duration, o.duration), this.ease = n(e[2], this.ease, o.ease), this.delay = u(e[3], this.delay, o.delay), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.auto = z.test(this.name), this.unit = r.unit || this.unit || G.defaultUnit, this.angle = r.angle || this.angle || G.defaultAngle, G.fallback || r.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + j + this.duration + "ms" + ("ease" != this.ease ? j + h[this.ease][0] : "") + (this.delay ? j + this.delay + "ms" : ""))
				}, t.set = function(t) {
					...
					t = this.convert(t, this.type), this.auto && ("auto" == n && (n = this.convert(this.get(), this.type)), "auto" == t && (t = e.call(this))), this.tween = new I({
						from: n,
						to: t,
			...
			P = f(X, function(t, e) {
				...
				t.init = function() {
					e.init.apply(this, arguments), this.current || (this.current = {}, J.perspective && G.perspective && (this.current.perspective = G.perspective, U(this.el, this.name, this.style(this.current)), this.redraw()))
				}, t.set = function(t) {
			...
			I = f(function(e) {
				...
				function a() {
					...
					if (i)
						for (S(a), e = F(), t = i; t--;)(n = d[t]) && n.render(e)
				}
			...
			Y = f(I, function(t, e) {
				t.init = function(t) {
					...
					var e, n;
					for (e in t.values) n = t.values[e], this.current[e] !== n && this.tweens.push(new I({
						name: e,
						from: this.current[e],
						to: n,
						duration: t.duration,
		...
		var U = t.style,
			...
			Q = {
				...
				"max-height": [X, _],
				"line-height": [X, E],
				"scroll-top": [C, b, "scrollTop"],
				"scroll-left": [C, b, "scrollLeft"]
			},
			J = {};
		L.transform && (Q.transform = [P], J = {
			x: [_, "translateX"],
			y: [_, "translateY"],
			rotate: [k],
			rotateX: [k],
	...
	var e = {},
		...
		r = t(function(t) {
			...
			var k = navigator.userAgent.toLowerCase(),
				...
				z = f.env.chrome = /chrome/.test(k) && /Google/.test(navigator.vendor) && parseInt(E.match(/chrome\/(\d+)\./)[1], 10),
				j = f.env.ios = /(ipod|iphone|ipad)/.test(k);
			f.env.safari = /safari/.test(k) && !z && !j;
			var M;
			...
			f.resize = s(m, A), f.scroll = s(m, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), f.redraw = s(), f.location = function(t) {
				window.location = t
	...
	t(function(t) {
		...
		e.define("forms", t.exports = function(t, n) {
			...
			function r(e, n) {
				...
				r.handler = null, r.redirect = i.attr("data-redirect"), z.test(s) ? r.handler = f : s || (v ? r.handler = l : j())
			}
...
var topics = ['Man City', 'Premiere League', 'Goal', 'Manuel Pellegrini', 'Fifa', 'Champions League', 'Keeper'];
var prependString = '';
var appendString = '';
